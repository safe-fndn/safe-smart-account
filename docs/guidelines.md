...
For this, a variable identifier should be defined (e.g. `fallback_manager.handler.address` for the handler address in the fallback manager contract) and hash it to generate the storage location from which the data should be loaded.
...
Note: Make sure to use a unique identifier, or unexpected behaviour will occur.
